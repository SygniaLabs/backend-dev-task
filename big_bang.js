...
index({'Lenoard': 'Then nearly fourteen billion expansion ago expansion started, wait!'}, 1);
...
assert.deepEqual(match('expanding'), [], 'Document with id = 1 was overridden by a new doc that does not contain the word expanding');
...
match('jedi');
const elapsed = process.hrtime(start)[1] / 1000000; // nano -> mili
