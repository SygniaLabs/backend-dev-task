...
assert.deepEqual(match('prove'), [1]); // Our search should support variations match, so in this case it should
                                               // find all documents containing - proving, prove, proves, proved..'
